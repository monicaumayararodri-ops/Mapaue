...
map.getView().fit([-9451324.490889, -2696915.831538, -4697347.139540, -1008020.954842], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">MAPA COOP 25UE</h2>';
        return titleElement;
    })(),
